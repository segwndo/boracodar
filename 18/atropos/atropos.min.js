        ...
        var w,
            ...
            A = function (t, e) {
                ...
                var S,
                    ...
                    B =
                        (o ? (N / 100) * M.stretchX : 0) *
                        (M.rotateYInvert ? -1 : 1),
                    Z =
                        (o ? (q / 100) * M.stretchY : 0) *
                        (M.rotateXInvert ? -1 : 1),
                    z = o
                        ? (Math.max(Math.abs(q), Math.abs(N)) / 100) *
                          M.stretchZ
                        : 0;
                T(
                    n,
            ...
            P = function (t) {
                if (M.rotate && g.isActive) {
                    ...
                    if (
                        ...
                        if (a * a + n * n >= 25) {
                            var r =
                                (180 * Math.atan2(Math.abs(n), Math.abs(a))) /
                                Math.PI;
                            l =
                                'scroll-y' === M.rotateTouch
                                    ? r > 45
                                    : 90 - r > 45;
                        }
                        !1 === l &&
        ...
        return (
            ...
            m &&
                ...
                M.rotateTouch &&
                    ('string' == typeof M.rotateTouch
                        ? m.classList.add(
                              'atropos-rotate-touch-' + M.rotateTouch
                          )
                        : m.classList.add('atropos-rotate-touch')),
